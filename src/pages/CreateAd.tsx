...
import {
  ...
  Image,
  Video,
  Link as LinkIcon // Renamed to avoid conflict with react-router-dom's Link
} from "lucide-react";
...
interface Ad {
  ...
  created_at: string;
  updated_at: string;
  link_url?: string; // Added link_url
}
...
export default function AdDetails() {
  ...
  const [formData, setFormData] = useState({
    ...
    image_url: "",
    video_url: "",
    link_url: "" // Added link_url to form data
  });
  ...
  const fetchAdData = async () => {
    try {
      ...
      setFormData({
        ...
        link_url: adData.link_url || "" // Set link_url
      });
    } catch (error: any) {
      toast({
    ...
    try {
      const { error } = await supabase
        ...
        .update({
          ...
          link_url: formData.link_url || null, // Update link_url
  ...
  const handleLearnMoreClick = () => {
    if (ad?.link_url) {
      ...
      toast({
        title: "No link URL",
        description: "This ad does not have a destination link configured.",
        variant: "info",
      });
    }
  };
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {ad.link_url ? (
                      <a href={ad.link_url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                        {ad.link_url}
                      </a>
                    ) : "No link URL set"}
                  </p>
                  ...
                  <div className="bg-white rounded-lg shadow-sm border max-w-sm mx-auto">
                    ...
                    <div className="p-4">
                      ...
                      <Button
                        ...
                        onClick={handleLearnMoreClick} // Use onClick to handle navigation
      ...
      <Dialog open={editing} onOpenChange={setEditing}>
        <DialogContent className="sm:max-w-[600px] mx-4 max-h-[90vh] overflow-y-auto">
          ...
          <div className="grid gap-4 py-4">
            ...
            {/* Link URL Input */}
            <div className="space-y-2">
              <Label htmlFor="edit-link-url">Destination URL (Link)</Label>
              <Input
                id="edit-link-url"
                type="url"
              ...
              />
              <p className="text-xs text-muted-foreground">
                The URL users will be directed to when they click your ad.
              </p>
            </div>
